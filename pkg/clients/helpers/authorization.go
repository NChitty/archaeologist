...
// to the request
func NewBearerAuthorizationRequestFunc(token string) clients.RequestEditorFn {
...
// to the request
func NewBasicAuthorizationRequestFunc(username string, password string) clients.RequestEditorFn {
	return func(ctx context.Context, req *http.Request) error {
